Shader "_MJ/Ch8/AlphaBlend_BothSide"
{
    Properties
    {
        ...
        [Enum(UnityEngine.Rendering.CullMode)] cullMode_Pass1("cullMode_Pass1", Float) = 2    //0=Off, 1= Front, 2=Back  默认背面剔除
        [Enum(UnityEngine.Rendering.CullMode)] cullMode_Pass2("cullMode_Pass2", Float) = 1    //0=Off, 1= Front, 2=Back  默认背面剔除
    }
    SubShader
    {
